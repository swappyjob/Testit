...
const SUITES = ['admin', 'teachers', 'e2e', 'edit', 'phone', 'search', 'disable', 'access', 'student-edit', 'export', 'password', 'reset', 'deadline', 'timer', 'image', 'negmark', 'multi', 'section', 'subscription', 'proctor', 'student-review', 'draft', 'resume', 'leaderboard', 'bank', 'audit', 'mathdraw'];
